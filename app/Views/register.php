...
<head>
    ...
    <style>
           body {
            ...
            padding: 0;
            height: 100vh;
            background-image: url('https://img.freepik.com/free-vector/winter-light-blue-gradient-background_53876-120755.jpg?ga=GA1.1.1553320582.1730781172');
        ...
        #image2 {
            background-image: url('https://st5.depositphotos.com/80800426/69588/i/450/depositphotos_695885344-stock-photo-blur-background-texture-theme.jpg');
...
<body>
    ...
    <?php if (session()->getFlashdata('errors')): ?>
        ...
        <div class="image-container" id="image1">
            <!-- <img src="/pp.png" alt="Background Image 1" style="display: none;"> -->
        </div>
        <div class="image-container" id="image2">
            <!-- <img src="/pp.png" alt="Background Image 2" style="display: none;"> -->
        </div>
        ...
        <div class="card" id="register-card">
            <div class="card-body">
                ...
                <p>Already have an account? <a href="/login"><button style="background-color: black; color: white; width: auto;">Login</button></a></p>
